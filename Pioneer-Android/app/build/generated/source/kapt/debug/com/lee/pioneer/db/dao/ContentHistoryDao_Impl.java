...
public final class ContentHistoryDao_Impl implements ContentHistoryDao {
  ...
  @Override
  public int queryContentHistoryCount() {
    final String _sql = "SELECT COUNT(*) FROM ContentHistory";
